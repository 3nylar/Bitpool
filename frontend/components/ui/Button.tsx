...
const variantClasses: Record<Variant, string> = {
  primary:
    "gradient-primary-btn text-white shadow-soft hover:brightness-105 active:brightness-95 disabled:opacity-50 disabled:cursor-not-allowed",
  secondary:
    "bg-surface text-ink border border-line hover:border-primary/40 hover:bg-primary-soft/40 disabled:opacity-50",
